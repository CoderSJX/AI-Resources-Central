...
3. [mlabonne/llm-course](https://github.com/mlabonne/llm-course)：Course on LLMs with roadmaps and Colab notebooks.
4. [rasbt/LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)：Implement ChatGPT-like LLM in PyTorch step by step.
5. [lutzroeder/netron](https://github.com/lutzroeder/netron)：Visualizer for neural, deep and machine learning models
6. [datawhalechina/prompt-engineering-for-developers](https://github.com/datawhalechina/prompt-engineering-for-developers)：吴恩达大模型系列课程中文版开发者LLM入门教程
7. [liguodongiot/llm-action](https://github.com/liguodongiot/llm-action)：本项目分享大模型技术原理与实战经验
8. [stas00/ml-engineering](https://github.com/stas00/ml-engineering)：Machine Learning Engineering的开放书籍
9. [mikeroyal/Self-Hosting-Guide](https://github.com/mikeroyal/Self-Hosting-Guide)：Self - Hosting Guide: local hosting and software management
10. [hua1995116/awesome-ai-painting](https://github.com/hua1995116/awesome-ai-painting)：AI绘画资料合集（多种内容及平台等）
11. [Mooler0410/LLMsPracticalGuide](https://github.com/Mooler0410/LLMsPracticalGuide)：LLMs实用指南资源（树、例、论文）列表。
12. [GoogleCloudPlatform/generative-ai](https://github.com/GoogleCloudPlatform/generative-ai)：Google Cloud生成式AI示例代码与笔记本
13. [kyrolabs/awesome-langchain](https://github.com/kyrolabs/awesome-langchain)：Awesome LangChain tools and projects list
14. [microsoft/DeepSpeedExamples](https://github.com/microsoft/DeepSpeedExamples)：使用DeepSpeed的示例模型
15. [huggingface/alignment-handbook](https://github.com/huggingface/alignment-handbook)：Robust recipes for aligning models with preferences
16. [trigaten/Learn_Prompting](https://github.com/trigaten/Learn_Prompting)：Prompt Engineering, Generative AI, LLM Guide by Learn Prompting
17. [bbycroft/llm-viz](https://github.com/bbycroft/llm-viz)：3D可视化GPT式大型语言模型
18. [ray-project/llm-numbers](https://github.com/ray-project/llm-numbers)：Numbers every LLM developer should know
19. [luban-agi/Awesome-AIGC-Tutorials](https://github.com/luban-agi/Awesome-AIGC-Tutorials)：Tutorials and resources for LLMs, AI painting etc.
20. [georgezouq/awesome-ai-in-finance](https://github.com/georgezouq/awesome-ai-in-finance)：精选的金融市场深度学习工具与策略
21. [howl-anderson/unlocking-the-power-of-llms](https://github.com/howl-anderson/unlocking-the-power-of-llms)：使用Prompts和Chains让ChatGPT提高生产力。
22. [ashishpatel26/LLM-Finetuning](https://github.com/ashishpatel26/LLM-Finetuning)：LLM Finetuning using peft
23. [ray-project/llm-applications](https://github.com/ray-project/llm-applications)：Guide to building RAG - based LLM production apps.
24. [premAI-io/state-of-open-source-ai](https://github.com/premAI-io/state-of-open-source-ai)：Clarity in fast - paced Open Source innovation.
25. [pionxzh/chatgpt-exporter](https://github.com/pionxzh/chatgpt-exporter)：Export and share ChatGPT conversation history
...
2. [lllyasviel/Fooocus](https://github.com/lllyasviel/Fooocus)：Focus on prompting and generation

3. [upscayl/upscayl](https://github.com/upscayl/upscayl)：Upscayl - 免费开源的AI图像放大器。

4. [s0md3v/roop](https://github.com/s0md3v/roop)：one - click face swap精简为：一键换脸

5. [invoke-ai/InvokeAI](https://github.com/invoke-ai/InvokeAI)：Invoke是Stable Diffusion的创意引擎，用于生成视觉媒体。

6. [facefusion/facefusion](https://github.com/facefusion/facefusion)：Industry leading face manipulation platform.

7. [Sanster/lama-cleaner](https://github.com/Sanster/lama-cleaner)：Image inpainting tool powered by SOTA AI Model.

8. [Mikubill/sd-webui-controlnet](https://github.com/Mikubill/sd-webui-controlnet)：WebUI扩展：ControlNet

9. [camenduru/stable-diffusion-webui-colab](https://github.com/camenduru/stable-diffusion-webui-colab)：stable diffusion webui的colab相关内容

10. [divamgupta/diffusionbee-stable-diffusion-ui](https://github.com/divamgupta/diffusionbee-stable-diffusion-ui)：Diffusion Bee：M1 Mac本地运行Stable Diffusion。

11. [Baiyuetribe/paper2gui](https://github.com/Baiyuetribe/paper2gui)：将AI论文转为图形界面，方便大众使用。

12. [Nutlope/roomGPT](https://github.com/Nutlope/roomGPT)：Upload room photo, use AI to generate dream room.

13. [easydiffusion/easydiffusion](https://github.com/easydiffusion/easydiffusion)：AI作画PC端1键操作，无技术门槛。

14. [Stability-AI/StableStudio](https://github.com/Stability-AI/StableStudio)：Generative AI community interface.

15. [carson-katri/dream-textures](https://github.com/carson-katri/dream-textures)：Stable Diffusion内置于Blender

16. [TheLastBen/fast-stable-diffusion](https://github.com/TheLastBen/fast-stable-diffusion)：fast - stable - diffusion与DreamBooth

17. [godly-devotion/MochiDiffusion](https://github.com/godly-devotion/MochiDiffusion)：Run Stable Diffusion natively on Mac.

18. [HumanAIGC/OutfitAnyone](https://github.com/HumanAIGC/OutfitAnyone)：Outfit Anyone: High - quality virtual clothing try - on

19. [sensity-ai/dot](https://github.com/sensity-ai/dot)：Deepfake进攻工具包

20. [leap-ai/headshots-starter](https://github.com/leap-ai/headshots-starter)

21. [Nutlope/restorePhotos](https://github.com/Nutlope/restorePhotos)：AI修复模糊的旧人脸照片。

22. [jina-ai/discoart](https://github.com/jina-ai/discoart)：Create Disco Diffusion artworks in one line

23. [mlc-ai/web-stable-diffusion](https://github.com/mlc-ai/web-stable-diffusion)：Bring stable diffusion models to web browsers, no server.

24. [all-in-aigc/aicover](https://github.com/all-in-aigc/aicover)：ai cover generator精简后：AI封面生成器
...
2. [lavague-ai/LaVague](https://github.com/lavague-ai/LaVague)：Large Action Model framework for AI Web Agents

3. [openchatai/OpenCopilot](https://github.com/openchatai/OpenCopilot)：🤖 🔥 语言到行动的引擎

4. [katanaml/sparrow](https://github.com/katanaml/sparrow)：Data processing with ML, LLM and Vision LLM

5. [BAAI-Agents/Cradle](https://github.com/BAAI-Agents/Cradle)：Cradle框架是GCC的首次尝试。

6. [n4ze3m/page-assist](https://github.com/n4ze3m/page-assist)：Use local AI models for web browsing
...
1. [xai-org/grok-1](https://github.com/xai-org/grok-1)：Grok公开版本

2. [tatsu-lab/stanford_alpaca](https://github.com/tatsu-lab/stanford_alpaca)：Code and docs for training Stanford Alpaca models.

3. [meta-llama/llama3](https://github.com/meta-llama/llama3)：Meta Llama 3官方GitHub网站

4. [state-spaces/mamba](https://github.com/state-spaces/mamba)：Mamba SSM架构

5. [CompVis/latent-diffusion](https://github.com/CompVis/latent-diffusion)：High-Resolution Image Synthesis via Latent Diffusion Models

6. [mlfoundations/open_clip](https://github.com/mlfoundations/open_clip)：Open source implementation of CLIP.

7. [mistralai/mistral-src](https://github.com/mistralai/mistral-src)：Mistral models的官方推理库

8. [Vaibhavs10/insanely-fast-whisper](https://github.com/Vaibhavs10/insanely-fast-whisper)

9. [01-ai/Yi](https://github.com/01-ai/Yi)：Large language models trained from scratch by @01-ai.

10. [HumanAIGC/EMO](https://github.com/HumanAIGC/EMO)：Emote Portrait Alive: Generating portrait videos with Audio2Video.

11. [Lightning-AI/lit-llama](https://github.com/Lightning-AI/lit-llama)：LLaMA语言模型基于nanoGPT的实现及相关功能。

12. [allenai/OLMo](https://github.com/allenai/OLMo)：OLMo的建模、训练、评估和推理代码

13. [google-research/albert](https://github.com/google-research/albert)：ALBERT：用于语言表征自监督学习的轻量BERT

14. [project-baize/baize-chatbot](https://github.com/project-baize/baize-chatbot)：Let ChatGPT teach chatbot in hours on one GPU.

15. [dvlab-research/LongLoRA](https://github.com/dvlab-research/LongLoRA)：Code and docs of LongLoRA & LongAlpaca (ICLR 2024)

16. [MetaGLM/FinGLM](https://github.com/MetaGLM/FinGLM)：FinGLM：构建开放公益持久金融大模型。

17. [google/maxtext](https://github.com/google/maxtext)：Simple, performant and scalable Jax LLM.

18. [google-research/FLAN](https://github.com/google-research/FLAN)

19. [lxtGH/OMG-Seg](https://github.com/lxtGH/OMG-Seg)：OMG-LLaVA和OMG-Seg代码库（CVPR-24与NeurIPS-24）

20. [openai/lm-human-preferences](https://github.com/openai/lm-human-preferences)：Code for paper on fine - tuning language models.

21. [THUDM/SwissArmyTransformer](https://github.com/THUDM/SwissArmyTransformer)：SwissArmyTransformer：开发Transformer变体的库。
...
2. [suno-ai/bark](https://github.com/suno-ai/bark)：Text - Prompted Generative Audio Model

3. [openai/CLIP](https://github.com/openai/CLIP)：CLIP：根据图像预测最相关文本片段

4. [Vision-CAIR/MiniGPT-4](https://github.com/Vision-CAIR/MiniGPT-4)：Open - sourced codes for MiniGPT - 4 and MiniGPT - v2

5. [hpcaitech/Open-Sora](https://github.com/hpcaitech/Open-Sora)：Open - Sora：让大众高效制作视频

6. [haotian-liu/LLaVA](https://github.com/haotian-liu/LLaVA)：NeurIPS'23 Oral的LLaVA向GPT-4V及以上能力构建

7. [fishaudio/fish-speech](https://github.com/fishaudio/fish-speech)：SOTA开源TTS

8. [borisdayma/dalle-mini](https://github.com/borisdayma/dalle-mini)：DALL·E Mini：由文本生成图像

9. [google-deepmind/alphafold](https://github.com/google-deepmind/alphafold)：AlphaFold 2开源代码。

10. [OpenBMB/OmniLMM](https://github.com/OpenBMB/OmniLMM)：MiniCPM-V 2.6: MLLM for images/videos on phone

11. [PKU-YuanGroup/Open-Sora-Plan](https://github.com/PKU-YuanGroup/Open-Sora-Plan)：Project to reproduce Sora, open source contribution.

12. [openai/shap-e](https://github.com/openai/shap-e)：Generate 3D objects from text or images.

13. [facebookresearch/seamless_communication](https://github.com/facebookresearch/seamless_communication)：Foundational models for speech & text translation.

14. [google-research/vision_transformer](https://github.com/google-research/vision_transformer)

15. [magic-research/magic-animate](https://github.com/magic-research/magic-animate)：CVPR 2024 MagicAnimate人类图像动画。

16. [ashawkey/stable-dreamfusion](https://github.com/ashawkey/stable-dreamfusion)：Text-to-3D, Image-to-3D, NeRF+Diffusion Mesh Export

17. [lucidrains/imagen-pytorch](https://github.com/lucidrains/imagen-pytorch)：Implementation of Imagen in Pytorch.

18. [openai/jukebox](https://github.com/openai/jukebox)：Code for "Jukebox: A Music Generative Model"

19. [deep-floyd/IF](https://github.com/deep-floyd/IF)

20. [netease-youdao/EmotiVoice](https://github.com/netease-youdao/EmotiVoice)：EmotiVoice: Multi - Voice & Prompt - Controlled TTS Engine

21. [IDEA-Research/GroundingDINO](https://github.com/IDEA-Research/GroundingDINO)：ECCV 2024 "Grounding DINO"官方实现

22. [FoundationVision/VAR](https://github.com/FoundationVision/VAR)：NeurIPS 2024 Oral：GPT超越扩散的官方实现

23. [threestudio-project/threestudio](https://github.com/threestudio-project/threestudio)：A unified 3D content generation framework.

24. [openai/guided-diffusion](https://github.com/openai/guided-diffusion)

25. [THUDM/CogVLM](https://github.com/THUDM/CogVLM)：先进的开放视觉语言模型及多模态预训练模型

26. [openai/consistency_models](https://github.com/openai/consistency_models)：Official repo for consistency models.

27. [levihsu/OOTDiffusion](https://github.com/levihsu/OOTDiffusion)：OOTDiffusion：可控虚拟试穿的潜扩散实现

28. [clovaai/donut](https://github.com/clovaai/donut)：OCR - free Donut & SynthDoG, ECCV 2022官方实现

29. [google/gemma_pytorch](https://github.com/google/gemma_pytorch)：PyTorch实现Google Gemma模型的官方版本

30. [QwenLM/Qwen-VL](https://github.com/QwenLM/Qwen-VL)：Alibaba Cloud's Qwen - VL chat & pretrained model repo.

31. [yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)：StyleTTS 2: Style Diffusion in Text - to - Speech

32. [snakers4/silero-models](https://github.com/snakers4/silero-models)：Silero Models: pre-trained simple speech models.

33. [salesforce/BLIP](https://github.com/salesforce/BLIP)：PyTorch code for BLIP in vision - language tasks

34. [google-deepmind/alphageometry](https://github.com/google-deepmind/alphageometry)

35. [metavoiceio/metavoice-src](https://github.com/metavoiceio/metavoice-src)：Foundational model for human - like TTS

36. [Luodian/Otter](https://github.com/Luodian/Otter)：Otter是基于OpenFlamingo的多模态模型。

37. [NExT-GPT/NExT-GPT](https://github.com/NExT-GPT/NExT-GPT)：Code and models for NExT - GPT multimodal LLM

38. [openai/improved-diffusion](https://github.com/openai/improved-diffusion)：Release for Improved Denoising Diffusion Models

39. [X-PLUG/MobileAgent](https://github.com/X-PLUG/MobileAgent)：Mobile - Agent: Mobile Device Operation Assistant Family

40. [dvlab-research/MiniGemini](https://github.com/dvlab-research/MiniGemini)：Mini - Gemini官方仓库，多模态视觉语言模型

41. [lucidrains/musiclm-pytorch](https://github.com/lucidrains/musiclm-pytorch)：Pytorch implementation of Google's MusicLM model.

42. [hustvl/Vim](https://github.com/hustvl/Vim)：Vision Mamba：视觉表征学习双向状态空间模型

43. [OpenGVLab/Ask-Anything](https://github.com/OpenGVLab/Ask-Anything)：CVPR2024 Highlight：ChatGPT等语言模型的视频理解

44. [microsoft/lida](https://github.com/microsoft/lida)：Large Language Models for Visual/Infographic Gen.

45. [google-research/frame-interpolation](https://github.com/google-research/frame-interpolation)：FILM: Frame Interpolation in ECCV 2022.

46. [InternLM/InternLM-XComposer](https://github.com/InternLM/InternLM-XComposer)：InternLM-XComposer2.5-OmniLive: 多模态长时音视频交互系统

47. [yerfor/GeneFace](https://github.com/yerfor/GeneFace)：GeneFace 3D说话脸合成：ICLR 2023官方代码

48. [OpenGVLab/InternImage](https://github.com/OpenGVLab/InternImage)：CVPR 2023 Highlight: InternImage with deformable convolutions

49. [google-deepmind/gemma](https://github.com/google-deepmind/gemma)：Google DeepMind的开放权重大型语言模型。

50. [baaivision/EVA](https://github.com/baaivision/EVA)：EVA Series: Visual Fantasies from BAAI

51. [MzeroMiko/VMamba](https://github.com/MzeroMiko/VMamba)：VMamba：基于mamba的视觉状态空间模型

52. [deepseek-ai/DeepSeek-VL](https://github.com/deepseek-ai/DeepSeek-VL)：DeepSeek - VL: Real - World Vision - Language Understanding

53. [openai/consistencydecoder](https://github.com/openai/consistencydecoder)：Consistency Distilled Diff VAE精简版

54. [gligen/GLIGEN](https://github.com/gligen/GLIGEN)：Open-Set Grounded Text - to - Image Generation

55. [dvlab-research/LISA](https://github.com/dvlab-research/LISA)：Project Page for "LISA: Reasoning Segmentation"

56. [3DTopia/LGM](https://github.com/3DTopia/LGM)：ECCV 2024 Oral, LGM高分辨率3D内容创建

57. [lyuchenyang/Macaw-LLM](https://github.com/lyuchenyang/Macaw-LLM)：Macaw-LLM：多模态语言建模，集成图文音

58. [OpenMotionLab/MotionGPT](https://github.com/OpenMotionLab/MotionGPT)：NeurIPS 2023 MotionGPT: 统一的运动 - 语言生成模型

59. [OpenGVLab/InternVideo](https://github.com/OpenGVLab/InternVideo)：ECCV2024视频基础模型与多模态数据

60. [openai/Video-Pre-Training](https://github.com/openai/Video-Pre-Training)：VPT: Learning to Act from Unlabeled Online Videos

61. [THUDM/ImageReward](https://github.com/THUDM/ImageReward)：NeurIPS 2023：ImageReward与文本生成图像

62. [evo-design/evo](https://github.com/evo-design/evo)：Biological foundation modeling from molecule to genome

63. [google-research/tapas](https://github.com/google-research/tapas)：End - to - end neural table - text models.

64. [apple/ml-aim](https://github.com/apple/ml-aim)：Repository with code and checkpoints for AIMv1/2 projects.

65. [showlab/Show-o](https://github.com/showlab/Show-o)：Repository for Show - o, a unified Transformer.

66. [ELLA-Diffusion/ELLA](https://github.com/ELLA-Diffusion/ELLA)：Equip Diffusion Models with LLM for Semantic Alignment

67. [declare-lab/tango](https://github.com/declare-lab/tango)：Diffusion models for text - to - audio generation.

68. [OpenBMB/VisCPM](https://github.com/OpenBMB/VisCPM)：基于CPM的中英双语多模态大模型系列

69. [BAAI-DCAI/Bunny](https://github.com/BAAI-DCAI/Bunny)：A family of lightweight multimodal models.

70. [OpenGVLab/VisionLLM](https://github.com/OpenGVLab/VisionLLM)：VisionLLM系列

71. [Ligo-Biosciences/AlphaFold3](https://github.com/Ligo-Biosciences/AlphaFold3)：开源的AlphaFold3实现

72. [Vchitect/SEINE](https://github.com/Vchitect/SEINE)：[ICLR 2024] SEINE：长短视频扩散模型
...
75. [OpenMOSS/AnyGPT](https://github.com/OpenMOSS/AnyGPT)：Code for "AnyGPT: Unified Multimodal LLM".

76. [RayVentura/ShortGPT](https://github.com/RayVentura/ShortGPT)：ShortGPT - AI framework for short video automation

77. [all-in-aigc/sorafm](https://github.com/all-in-aigc/sorafm)：Sora.FM的Sora AI视频生成器

### 多语言模型

1. [THUDM/ChatGLM-6B](https://github.com/THUDM/ChatGLM-6B)：ChatGLM-6B：开源双语对话语言模型

2. [UKPLab/sentence-transformers](https://github.com/UKPLab/sentence-transformers)：State-of-the-Art Text Embeddings（已最简，无需精简）

3. [FlagAlpha/Llama2-Chinese](https://github.com/FlagAlpha/Llama2-Chinese)：Llama中文社区，Llama3开放体验、微调及学习资料。

4. [THUDM/ChatGLM3](https://github.com/THUDM/ChatGLM3)：ChatGLM3系列：开源双语对话语言模型

5. [ymcui/Chinese-LLaMA-Alpaca-2](https://github.com/ymcui/Chinese-LLaMA-Alpaca-2)：中文LLaMA - 2 & Alpaca - 2大模型二期及64K模型

6. [InternLM/InternLM](https://github.com/InternLM/InternLM)：InternLM2.5 base和chat模型发布，支持1M上下文

7. [Facico/Chinese-Vicuna](https://github.com/Facico/Chinese-Vicuna)：Chinese-Vicuna：基于LLaMA的中文模型

8. [wenge-research/YaYi](https://github.com/wenge-research/YaYi)：雅意大模型由中科闻歌研发，安全可靠。

9. [LinkSoul-AI/Chinese-Llama-2-7b](https://github.com/LinkSoul-AI/Chinese-Llama-2-7b)：开源社区首个可下载运行的中文LLaMA2模型

10. [MiuLab/Taiwan-LLM](https://github.com/MiuLab/Taiwan-LLM)：Taiwan traditional Mandarin LLMs.

11. [zjunlp/KnowLM](https://github.com/zjunlp/KnowLM)：An open - sourced large language model framework.

12. [google-research/multilingual-t5](https://github.com/google-research/multilingual-t5)

13. [SkyworkAI/Skywork](https://github.com/SkyworkAI/Skywork)：Skywork模型预训练数据及开源内容

14. [ymcui/Chinese-LLaMA-Alpaca](https://github.com/ymcui/Chinese-LLaMA-Alpaca)：中文LLaMA&Alpaca大模型本地CPU/GPU训练部署

15. [LC1332/Luotuo-Chinese-LLM](https://github.com/LC1332/Luotuo-Chinese-LLM)：骆驼：华中师大等开发的开源中文语言模型。

16. [wenge-research/YAYI2](https://github.com/wenge-research/YAYI2)：YAYI 2是中科闻歌开源大语言模型，预训练语料超2万亿Tokens

### 工作流程自动化

1. [StanGirard/quivr](https://github.com/StanGirard/quivr)：Opiniated RAG可轻松集成GenAI到产品

2. [danielmiessler/fabric](https://github.com/danielmiessler/fabric)：fabric是开源AI框架，可解决特定问题。

3. [openai-translator/openai-translator](https://github.com/openai-translator/openai-translator)：基于ChatGPT API的划词翻译插件与应用

4. [Skyvern-AI/skyvern](https://github.com/Skyvern-AI/skyvern)：Automate browser workflows with LLMs and CV.

5. [activepieces/activepieces](https://github.com/activepieces/activepieces)：Open source AI automation tool, 200+ integrations.

6. [OthersideAI/self-operating-computer](https://github.com/OthersideAI/self-operating-computer)：A framework for multimodal models to operate a computer.

7. [microsoft/UFO](https://github.com/microsoft/UFO)：UI-Focused Agent for Windows OS Interaction.

8. [yihong0618/bilingual_book_maker](https://github.com/yihong0618/bilingual_book_maker)：Make bilingual epub books with AI translate

9. [aisingapore/TagUI](https://github.com/aisingapore/TagUI)：Free RPA tool from AI Singapore

10. [openchatai/OpenChat](https://github.com/openchatai/OpenChat)：LLMs custom - chatbots console.

11. [KillianLucas/01](https://github.com/KillianLucas/01)：Open - source voice interface for multiple devices.

12. [xlang-ai/OpenAgents](https://github.com/xlang-ai/OpenAgents)：[COLM 2024] OpenAgents: Open language agents platform

13. [Cormanz/smartgpt](https://github.com/Cormanz/smartgpt)：A program enabling LLMs to do complex tasks via plugins.

14. [fiatrete/OpenDAN-Personal-AI-OS](https://github.com/fiatrete/OpenDAN-Personal-AI-OS)：OpenDAN是整合AI模块的开源个人AI操作系统。

15. [OS-Copilot/FRIDAY](https://github.com/OS-Copilot/FRIDAY)：Self - improving agent integrated into OS for daily tasks.
...
2. [guillaumekln/faster-whisper](https://github.com/guillaumekln/faster-whisper)：Faster Whisper转录借助CTranslate2

3. [bentoml/OpenLLM](https://github.com/bentoml/OpenLLM)：Run open - source LLMs as OpenAI API in cloud.

4. [huggingface/text-generation-inference](https://github.com/huggingface/text-generation-inference)：Large Language Model Text Generation Inference

5. [FMInference/FlexGen](https://github.com/FMInference/FlexGen)：Running large language models on single GPU for throughput.

6. [triton-inference-server/server](https://github.com/triton-inference-server/server)：Triton Inference Server: optimized inferencing solution.

7. [dusty-nv/jetson-inference](https://github.com/dusty-nv/jetson-inference)：Hello AI World之TensorRT与Jetson部署相关

8. [openvinotoolkit/openvino](https://github.com/openvinotoolkit/openvino)：OpenVINO™, open - source AI inference toolkit.

9. [zilliztech/GPTCache](https://github.com/zilliztech/GPTCache)：Semantic cache for LLMs, integrated with LangChain and llama_index.

10. [Portkey-AI/gateway](https://github.com/Portkey-AI/gateway)：AI Gateway集成防护栏，可路由多种服务。

11. [tensorflow/serving](https://github.com/tensorflow/serving)：Flexible high - performance ML model serving system.

12. [xorbitsai/inference](https://github.com/xorbitsai/inference)：Xinference lets you replace GPT in app with one line.

13. [allegroai/clearml](https://github.com/allegroai/clearml)：ClearML：一站式MLOps/LLMOps解决方案

14. [InternLM/lmdeploy](https://github.com/InternLM/lmdeploy)：LMDeploy：压缩、部署和服务LLMs的工具包。

15. [argmaxinc/WhisperKit](https://github.com/argmaxinc/WhisperKit)：Apple Silicon设备端语音识别

16. [kserve/kserve](https://github.com/kserve/kserve)：Kubernetes上的标准化无服务器ML推理平台

17. [neuralmagic/deepsparse](https://github.com/neuralmagic/deepsparse)：CPU的稀疏感知深度学习推理运行时

18. [huggingface/text-embeddings-inference](https://github.com/huggingface/text-embeddings-inference)：A fast inference solution for text embeddings models

19. [open-mmlab/mmdeploy](https://github.com/open-mmlab/mmdeploy)：OpenMMLab的模型部署框架。

20. [ModelTC/lightllm](https://github.com/ModelTC/lightllm)：LightLLM是Python的轻量高速LLM框架。

21. [predibase/lorax](https://github.com/predibase/lorax)：Multi - LoRA inference server for thousands of LLMs

22. [langchain-ai/langserve](https://github.com/langchain-ai/langserve)：LangServe 🦜️🏓

23. [S-LoRA/S-LoRA](https://github.com/S-LoRA/S-LoRA)：S-LoRA: 同时服务数千个LoRA适配器

24. [michaelfeil/infinity](https://github.com/michaelfeil/infinity)：Infinity是文本嵌入等的服务引擎。

25. [roboflow/inference](https://github.com/roboflow/inference)：将设备变为计算机视觉项目指挥中心。

26. [ray-project/ray-llm](https://github.com/ray-project/ray-llm)：RayLLM：Ray上的大型语言模型

27. [PygmalionAI/aphrodite-engine](https://github.com/PygmalionAI/aphrodite-engine)：Large - scale LLM inference engine

28. [punica-ai/punica](https://github.com/punica-ai/punica)：Serving multiple finetuned LLM as one

29. [msoedov/langcorn](https://github.com/msoedov/langcorn)：Serving LangChain LLM apps & agents with FastApi.

### 向量数据库

1. [facebookresearch/faiss](https://github.com/facebookresearch/faiss)：A library for dense vector search and clustering.

2. [milvus-io/milvus](https://github.com/milvus-io/milvus)：Milvus是用于向量ANN搜索的高性能向量数据库。

3. [chroma-core/chroma](https://github.com/chroma-core/chroma)：AI原生的开源嵌入数据库

4. [spotify/annoy](https://github.com/spotify/annoy)：C++/Python近似最近邻，优化内存与磁盘读写

5. [weaviate/weaviate](https://github.com/weaviate/weaviate)：Weaviate是开源向量数据库，可结合多种功能。

6. [activeloopai/deeplake](https://github.com/activeloopai/deeplake)：Database for AI, store various data for use with LLMs.

7. [vespa-engine/vespa](https://github.com/vespa-engine/vespa)：AI + Data, online. 网址https://vespa.ai

8. [lancedb/lancedb](https://github.com/lancedb/lancedb)：Serverless向量数据库，为AI应用添长期记忆

9. [marqo-ai/marqo](https://github.com/marqo-ai/marqo)：Unified embedding generation and cloud search engine.

10. [nmslib/hnswlib](https://github.com/nmslib/hnswlib)：C++/python库：快速近似最近邻（仅头文件）

11. [unum-cloud/usearch](https://github.com/unum-cloud/usearch)：Fast开源搜索聚类引擎，多语言支持。

12. [tensorchord/pgvecto.rs](https://github.com/tensorchord/pgvecto.rs)：Scalable Vector Search in Postgres, not Database.

13. [spotify/voyager](https://github.com/spotify/voyager)：Python和Java近似最近邻搜索库，易用简单。

14. [qdrant/qdrant](https://github.com/qdrant/qdrant)：Qdrant - 高性能向量数据库与搜索引擎。

15. [neuml/txtai](https://github.com/neuml/txtai)：Open - source embeddings database for language tasks
16. [rapidsai/raft](https://github.com/rapidsai/raft)：RAFT有机器学习和检索算法，CUDA加速。

### 教育应用

1. [JushBJJ/Mr.-Ranedeer-AI-Tutor](https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor)：GPT-4 AI Tutor Prompt for personalized learning.

2. [Nutlope/llamatutor](https://github.com/Nutlope/llamatutor)：AI个人导师，由Llama 3.1构建。

3. [codeacme17/examor](https://github.com/codeacme17/examor)：For students etc., let LLMs help with learning.
...
2. [iterative/dvc](https://github.com/iterative/dvc)：Data Versioning与ML Experiments

3. [HigherOrderCO/HVM](https://github.com/HigherOrderCO/HVM)：A massively parallel optimal Rust functional runtime.

4. [marimo-team/marimo](https://github.com/marimo-team/marimo)：Python的反应式笔记本：多种功能。

5. [arogozhnikov/einops](https://github.com/arogozhnikov/einops)：Flexible tensor operations for reliable code

6. [replicate/cog](https://github.com/replicate/cog)：Containers for machine learning

7. [jessevig/bertviz](https://github.com/jessevig/bertviz)：BertViz: Visualize Attention in NLP Models.

8. [AbdBarho/stable-diffusion-webui-docker](https://github.com/AbdBarho/stable-diffusion-webui-docker)：Easy Docker Stable Diffusion setup with UI

9. [huggingface/safetensors](https://github.com/huggingface/safetensors)：Simple, safe tensor storage and distribution.

10. [wangzhaode/mnn-llm](https://github.com/wangzhaode/mnn-llm)：llm基于mnn部署项目。

11. [ajndkr/lanarky](https://github.com/ajndkr/lanarky)：Web framework for building LLM microservices



### 数据集工程

1. [huggingface/datasets](https://github.com/huggingface/datasets)：The largest ML datasets hub with efficient tools.

2. [BuilderIO/gpt-crawler](https://github.com/BuilderIO/gpt-crawler)：Crawl site, generate knowledge files from URL.

3. [joke2k/faker](https://github.com/joke2k/faker)：Faker是生成假数据的Python包。

4. [DS4SD/docling](https://github.com/DS4SD/docling)：Prepare documents for gen AI.

5. [openai/tiktoken](https://github.com/openai/tiktoken)：tiktoken是用于OpenAI模型的快速BPE分词器。

6. [cleanlab/cleanlab](https://github.com/cleanlab/cleanlab)：AI包用于真实数据的质量与机器学习

7. [karpathy/minbpe](https://github.com/karpathy/minbpe)：Minimal clean BPE code for LLM tokenization.

8. [huggingface/tokenizers](https://github.com/huggingface/tokenizers)：Fast State - of - the - Art Tokenizers for Research & Production

9. [snorkel-team/snorkel](https://github.com/snorkel-team/snorkel)：System for quickly generating weak - supervision training data.

10. [arsenetar/dupeguru](https://github.com/arsenetar/dupeguru)：Find duplicate files

11. [QuivrHQ/MegaParse](https://github.com/QuivrHQ/MegaParse)：File Parser for LLM Ingestion, parses PDFs etc.

12. [togethercomputer/RedPajama-Data](https://github.com/togethercomputer/RedPajama-Data)：RedPajama-Data库含大模型训练数据集准备代码

13. [lk-geimfari/mimesis](https://github.com/lk-geimfari/mimesis)：Mimesis是Python数据生成器，可多语言造数据。

14. [Instruction-Tuning-with-GPT-4/GPT-4-LLM](https://github.com/Instruction-Tuning-with-GPT-4/GPT-4-LLM)：Instruction Tuning用GPT - 4。

15. [yizhongw/self-instruct](https://github.com/yizhongw/self-instruct)：Aligning pretrained models with self - generated instruction data.

16. [dedupeio/dedupe](https://github.com/dedupeio/dedupe)：A python库，用于模糊匹配、去重和实体解析

17. [argilla-io/argilla](https://github.com/argilla-io/argilla)：Argilla：AI工程师与专家构建数据集的协作工具

18. [mshumer/gpt-llm-trainer](https://github.com/mshumer/gpt-llm-trainer)

19. [life4/textdistance](https://github.com/life4/textdistance)：Compute distance between sequences. 30+ python algorithms.

20. [Docta-ai/docta](https://github.com/Docta-ai/docta)：A Doctor for Your Data (精简版)

21. [alibaba/data-juicer](https://github.com/alibaba/data-juicer)：为大模型提供高质量、易“消化”的数据。

22. [QData/TextAttack](https://github.com/QData/TextAttack)：TextAttack：Python框架用于NLP相关任务。

23. [seatgeek/thefuzz](https://github.com/seatgeek/thefuzz)：Python中的模糊字符串匹配

24. [ekzhu/datasketch](https://github.com/ekzhu/datasketch)：MinHash等8种算法名

25. [thunlp/UltraChat](https://github.com/thunlp/UltraChat)：Large-scale multi - round chat data and models

26. [modAL-python/modAL](https://github.com/modAL-python/modAL)：Python的模块化主动学习框架。

27. [google-research/uda](https://github.com/google-research/uda)：Unsupervised Data Augmentation (UDA)

28. [huggingface/datatrove](https://github.com/huggingface/datatrove)：Free data processing with customizable pipeline blocks.

29. [refuel-ai/autolabel](https://github.com/refuel-ai/autolabel)：Label, clean and enrich text datasets via LLMs.

30. [google-deepmind/code_contests](https://github.com/google-deepmind/code_contests)

31. [Tencent/MedicalNet](https://github.com/Tencent/MedicalNet)：MedicalNet offers 3D - ResNet models and code.

32. [argilla-io/distilabel](https://github.com/argilla-io/distilabel)：Distilabel为工程师提供数据与AI反馈框架。

33. [google-deepmind/mathematics_dataset](https://github.com/google-deepmind/mathematics_dataset)：Dataset code generates school - level math Q&A pairs.

34. [openai/prm800k](https://github.com/openai/prm800k)：80万LLM解决数学问题的步骤正确标签

35. [salesforce/WikiSQL](https://github.com/salesforce/WikiSQL)：Large semantic parsing corpus for natural language interfaces.

36. [anthropics/hh-rlhf](https://github.com/anthropics/hh-rlhf)：Human preference data for RLHF training an assistant

37. [moj-analytical-services/splink](https://github.com/moj-analytical-services/splink)：Fast, accurate SQL-backend probabilistic data linkage.

38. [dleemiller/WordLlama](https://github.com/dleemiller/WordLlama)：Things to do with LLM token embeddings.

39. [AI4Finance-Foundation/FinRL-Meta](https://github.com/AI4Finance-Foundation/FinRL-Meta)：FinRL-Meta: Datasets and environments for FinRL.

40. [tensorflow/text](https://github.com/tensorflow/text)：Make text first - class in TensorFlow.

41. [google-research/deduplicate-text-datasets](https://github.com/google-research/deduplicate-text-datasets)

42. [allenai/dolma](https://github.com/allenai/dolma)：Data and tools for OLMo pre - training data.

43. [lilacai/lilac](https://github.com/lilacai/lilac)：Curate better data for LLMs.

44. [1e0ng/simhash](https://github.com/1e0ng/simhash)：Python实现的Simhash算法

45. [google-deepmind/tree](https://github.com/google-deepmind/tree)：tree库用于处理嵌套数据结构

46. [xtreme1-io/xtreme1](https://github.com/xtreme1-io/xtreme1)：Xtreme1: all - in - one multimodal data training platform.

47. [datadreamer-dev/DataDreamer](https://github.com/datadreamer-dev/DataDreamer)：DataDreamer: Prompt, generate data, train models.
...
2. [explodinggradients/ragas](https://github.com/explodinggradients/ragas)：Supercharge LLM application evaluations.

3. [EleutherAI/lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness)：A framework for few - shot language model evaluation.

4. [erikbern/ann-benchmarks](https://github.com/erikbern/ann-benchmarks)：Python近似最近邻库的基准测试

5. [Trusted-AI/adversarial-robustness-toolbox](https://github.com/Trusted-AI/adversarial-robustness-toolbox)：ART - Python库，机器学习安全相关

6. [open-compass/opencompass](https://github.com/open-compass/opencompass)：OpenCompass评估LLM，支持100+数据集。

7. [Arize-ai/phoenix](https://github.com/Arize-ai/phoenix)：AI可观测性与评估

8. [NVIDIA/NeMo-Guardrails](https://github.com/NVIDIA/NeMo-Guardrails)：NeMo Guardrails：为对话系统添加可编程防护。

9. [Giskard-AI/giskard](https://github.com/Giskard-AI/giskard)：Open - Source AI/LLM Evaluation & Testing

10. [confident-ai/deepeval](https://github.com/confident-ai/deepeval)：LLM Evaluation Framework（精简后）

11. [fchollet/ARC](https://github.com/fchollet/ARC)：The Abstraction and Reasoning Corpus

12. [llm-attacks/llm-attacks](https://github.com/llm-attacks/llm-attacks)：Universal and Transferable Attacks on Aligned LMs

13. [leondz/garak](https://github.com/leondz/garak)：LLM漏洞扫描器

14. [jeinlee1991/chinese-llm-benchmark](https://github.com/jeinlee1991/chinese-llm-benchmark)：中文大模型能力评测榜单涵盖134个模型。

15. [google/BIG-bench](https://github.com/google/BIG-bench)：Beyond Imitation Game: benchmark for language models

16. [meta-llama/PurpleLlama](https://github.com/meta-llama/PurpleLlama)：Tools to assess and improve LLM security.

17. [openai/human-eval](https://github.com/openai/human-eval)：Code for "Evaluating LLMs Trained on Code"

18. [salesforce/decaNLP](https://github.com/salesforce/decaNLP)：The Natural Language Decathlon: NLP multitask challenge.

19. [THUDM/AgentBench](https://github.com/THUDM/AgentBench)：ICLR'24: Benchmark for Evaluating LLMs as Agents

20. [truera/trulens](https://github.com/truera/trulens)：LLM实验的评估与跟踪

21. [princeton-nlp/SWE-bench](https://github.com/princeton-nlp/SWE-bench)：[ICLR 2024] SWE - bench: Github Issues for LMs

22. [Lightning-AI/torchmetrics](https://github.com/Lightning-AI/torchmetrics)：Machine learning metrics for distributed PyTorch apps.

23. [openai/simple-evals](https://github.com/openai/simple-evals)

24. [huggingface/evaluate](https://github.com/huggingface/evaluate)：Evaluate: Library for evaluating ML models & datasets.

25. [embeddings-benchmark/mteb](https://github.com/embeddings-benchmark/mteb)：MTEB：大规模文本嵌入基准测试。

26. [Azure/PyRIT](https://github.com/Azure/PyRIT)：PyRIT是识别生成式AI风险的开源框架。

27. [stanford-crfm/helm](https://github.com/stanford-crfm/helm)：HELM框架用于评估多种模型

28. [TransformerLensOrg/TransformerLens](https://github.com/TransformerLensOrg/TransformerLens)：A library for interpretability of GPT - style models

29. [beir-cellar/beir](https://github.com/beir-cellar/beir)：A Heterogeneous IR Benchmark, easy to use across 15+ datasets.

30. [microsoft/CodeXGLUE](https://github.com/microsoft/CodeXGLUE)：CodeXGLUE

31. [google-deepmind/bsuite](https://github.com/google-deepmind/bsuite)：bsuite: experiments on RL agent core capabilities.

32. [CalculatedContent/WeightWatcher](https://github.com/CalculatedContent/WeightWatcher)：WeightWatcher: Predicting DNN accuracy.

33. [facebookresearch/LAMA](https://github.com/facebookresearch/LAMA)：Language Model Analysis

34. [evalplus/evalplus](https://github.com/evalplus/evalplus)：Rigourous evaluation of LLM -synthesized code - NeurIPS, COLM

35. [vectara/hallucination-leaderboard](https://github.com/vectara/hallucination-leaderboard)：LLM总结短文时产生幻觉的性能排行榜

36. [hendrycks/test](https://github.com/hendrycks/test)：Measuring Massive Multitask Language Understanding

37. [mlcommons/inference](https://github.com/mlcommons/inference)：MLPerf™推理基准的参考实现

38. [openai/grade-school-math](https://github.com/openai/grade-school-math)

39. [rlancemartin/auto-evaluator](https://github.com/rlancemartin/auto-evaluator)：LLM QA链的评估工具

40. [openai/automated-interpretability](https://github.com/openai/automated-interpretability)

41. [allenai/natural-instructions](https://github.com/allenai/natural-instructions)：Expanding natural instructions

42. [WeOpenML/PandaLM](https://github.com/WeOpenML/PandaLM)

43. [thu-coai/Safety-Prompts](https://github.com/thu-coai/Safety-Prompts)：中文安全prompts用于评估和提升大模型安全

44. [salesforce/OmniXAI](https://github.com/salesforce/OmniXAI)：OmniXAI: 可解释AI的一个库

45. [bigcode-project/bigcode-evaluation-harness](https://github.com/bigcode-project/bigcode-evaluation-harness)：A framework for evaluating autoregressive code models.
...
1. [kubeflow/kubeflow](https://github.com/kubeflow/kubeflow)：Kubernetes机器学习工具包

2. [Netflix/metaflow](https://github.com/Netflix/metaflow)：Open Source AI/ML Platform.

3. [skypilot-org/skypilot](https://github.com/skypilot-org/skypilot)：SkyPilot在多平台运行AI和批处理作业。

4. [gpuweb/gpuweb](https://github.com/gpuweb/gpuweb)：Where the Web GPU work occurs.

5. [zenml-io/zenml](https://github.com/zenml-io/zenml)：ZenML: Bridge between ML and Ops.

6. [higgsfield-ai/higgsfield](https://github.com/higgsfield-ai/higgsfield)：Fault - tolerant GPU orchestration and ML framework.
...
2. [reorproject/reor](https://github.com/reorproject/reor)：Private local AI app for high entropy people.

3. [shibing624/pycorrector](https://github.com/shibing624/pycorrector)：pycorrector是文本纠错工具，支持多种模型。

4. [BlinkDL/AI-Writer](https://github.com/BlinkDL/AI-Writer)：AI基于RWKV模型写小说（玄幻、言情等）

5. [mshumer/gpt-author](https://github.com/mshumer/gpt-author)

6. [Nutlope/twitterbio](https://github.com/Nutlope/twitterbio)：Generate Twitter bio using AI.

7. [nhaouari/obsidian-textgenerator-plugin](https://github.com/nhaouari/obsidian-textgenerator-plugin)：Text Generator for Obsidian, uses various AI providers.
...
2. [RUCAIBox/LLMSurvey](https://github.com/RUCAIBox/LLMSurvey)：GitHub上“A Survey of Large Language Models”的官方页面。

3. [WooooDyy/LLM-Agent-Paper-List](https://github.com/WooooDyy/LLM-Agent-Paper-List)：Paper list of 86 - page "Large Language Model Based Agents"

4. [wgwang/LLMs-In-China](https://github.com/wgwang/LLMs-In-China)：中国大模型

5. [opendilab/awesome-RLHF](https://github.com/opendilab/awesome-RLHF)：精选人类反馈强化学习资源（持续更新）

6. [DSXiangLi/DecryptPrompt](https://github.com/DSXiangLi/DecryptPrompt)：总结Prompt&LLM论文、开源数据、AIGC应用

7. [FreedomIntelligence/Medical_NLP](https://github.com/FreedomIntelligence/Medical_NLP)：Medical NLP Competition, dataset, large models

8. [EgoAlpha/prompt-in-context-learning](https://github.com/EgoAlpha/prompt-in-context-learning)：Awesome resources for in - context learning and prompt engineering.

9. [taranjeet/awesome-gpts](https://github.com/taranjeet/awesome-gpts)：All GPTs created by the community.

10. [eugeneyan/open-llms](https://github.com/eugeneyan/open-llms)：可用于商业的开放LLMs列表。

11. [Shubhamsaboo/awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)：Collection of LLM apps with RAG using various models.

12. [chiphuyen/aie-book](https://github.com/chiphuyen/aie-book)：Resources for AI engineers and book by Chip Huyen.
...
2. [Helicone/helicone](https://github.com/Helicone/helicone)：Open source LLM observability, one line of code.

3. [whylabs/whylogs](https://github.com/whylabs/whylogs)：开源机器学习数据日志库，支持隐私保护。

4. [uptrain-ai/uptrain](https://github.com/uptrain-ai/uptrain)：UpTrain是评估改进生成式AI应用的开源平台。

5. [labmlai/labml](https://github.com/labmlai/labml)：用手机监控深度学习模型训练与硬件使用

6. [lmnr-ai/lmnr](https://github.com/lmnr-ai/lmnr)：Laminar：开源AI工程产品一体化平台

7. [lunary-ai/lunary](https://github.com/lunary-ai/lunary)：LLMs生产工具包：可观察、提示管理与评估

8. [dillionverma/llm.report](https://github.com/dillionverma/llm.report)：llm.report：OpenAI日志分析平台，开源。

9. [whylabs/langkit](https://github.com/whylabs/langkit)：LangKit: 开源LLM监测工具，含多种功能。

10. [evidentlyai/evidently](https://github.com/evidentlyai/evidently)：Evidently是开源ML和LLM可观测框架。

11. [traceloop/openllmetry](https://github.com/traceloop/openllmetry)：Open - source LLM app observability via OpenTelemetry

12. [llmonitor/llmonitor](https://github.com/llmonitor/llmonitor)：LLMs生产工具包：可观察、管理和评估提示。



### 数据管理

1. [ibis-project/ibis](https://github.com/ibis-project/ibis)：Python可移植的数据框库。

2. [SuperDuperDB/superduperdb](https://github.com/SuperDuperDB/superduperdb)：Superduper: Build AI apps and workflows on existing data.

3. [run-llama/llama-hub](https://github.com/run-llama/llama-hub)：社区制作的LLM数据加载器库，用于LlamaIndex和/或LangChain

4. [webdataset/webdataset](https://github.com/webdataset/webdataset)：High-performance Python I/O system for deep learning.

5. [NVIDIA/aistore](https://github.com/NVIDIA/aistore)：AIStore: 面向AI应用的可扩展存储

6. [mosaicml/streaming](https://github.com/mosaicml/streaming)：A Data Streaming Library for NN Training
